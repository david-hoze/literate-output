...
--   * bit-source-literate.md Γאפ bit.cabal + all .hs source files (excluding test/)
--   * bit-tests-literate.md  Γאפ everything under test/
--   * bit-docs-literate.md   Γאפ all .md files under docs/
--
...
getExplanation rel
  | rel == "bit.cabal"                = "*Build configuration Γאפ package metadata and dependencies.*"
  | "Internal/" `isPrefixOf` rel       = "*Internal module Γאפ implementation details.*"
  | "bit/Internal/" `isPrefixOf` rel  = "*Internal module Γאפ implementation details.*"
  | rel == "bit.hs"                   = "*Entry point Γאפ main executable.*"
  | "bit/" `isPrefixOf` rel           = "*Core module Γאפ application logic.*"
...
main = do
  ...
  writeDocument sourcePath
    "bit Γאפ Literate Programming Document"
    "This document contains all Haskell source files and the cabal\n\
    \file for the bit project, presented in literate-programming style."
    root sourceFiles
  ...
  writeDocument testsPath
    "bit Γאפ Tests (Literate Programming Document)"
  ...
  writeDocument docsPath
    "bit Γאפ Documentation (Literate Programming Document)"
